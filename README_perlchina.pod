...
=item 到 data/origin/www.perl.org/ 目录下找 .new 后缀名挑选你想翻译的页面。如果你看到存在与你挑选的 .new 的文件同名的 .old 文件，说明这个页面正在被别人翻译，请挑选其他文件。
...
=item 统一使用中文标点。英文和中文交界的地方要留一个空格，包括英文和中文标点交界的地方。
