...
PerlChina 社区网站是对 L<www.perl.org> 、L<search.cpan.org> 、 L<learn.perl.org> 等 Perl 资源的一个本地化。除了翻译原有内容，还会添加一些本地的内容和特色的功能。翻译工作正在进行中，尚未翻译的部分会直接显示原有内容。志愿者可申请翻译尚无人翻译的内容。
